...
closedata4 = closedata4.pct_change().cumsum().dropna(how='all')
closedata4 = closedata4.apply(zscore).dropna(axis=1, how='all')

closedata5.sort_values(by='date', inplace=True)
closedata5 = closedata5.pct_change().cumsum().dropna(how='all')
